...
BOOST_DIR = "/mnt/c/Program Files/boost/boost_1_67_0/stage/lib"
ZSTD_DIR  = "/mnt/c/Users/Alessandro/IO/CEDS/zstd-dev/lib"
...
$(EXE): $(OBJ)
	$(CC) $(CCFLAGS) $(OPTFLAGS) $(LDFLAGS) $^ -o $@ $(LDLIBS) -Xlinker --verbose
